...
class Offer extends Model
{
    ...
    protected $fillable=['name_ar','name_en','price','photo','created_at','updated_at','details_ar','details_en','photo']; //العناصر التي توضع هنا  تستطيع الأضافة عليها في  الجدول، أي تستطيع التخزين داخلها
