...
return redirect() -> back() -> with(['success' => {{__(key:'messages.update_Data_success')}} 'تم تحديث البيانات بنجاح']);
...
public function deleteoffer($offer_id){
    ...
    if(!$offer){
    return redirect() -> back() -> with(['error' = {{__(key:'messages.offer_not_exist')}} 'العرض غير موجود' ] );
    }
