...
*/
    ...
    public function offer_post(Request $request)
    {
    ...
    protected function getMessage(){
        ...
        return
         $message = ['name.unique' => 'messages.offer name required',
                     'price.numeric' => 'enter number'
        ];

      /*  $message = ['name.unique' => __(key:'messages.offer name required'),
        'price.numeric' =>__(key:'messages.enter number')
         ];*/
