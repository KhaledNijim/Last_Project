...
*/
    ...
    public function create()
    {
        ...
        $offers = Offer::select('name','price','photo','details') -> get();

        return view(view: 'welcome3');->with(compact('selections'));
        return view(view: 'welcome3',compact('$offers'));->with(compact('selections'));
