...
$offers2 = Offer::select('id','name_ar','name_en','price','details_ar','details_en') -> find($offer_id);
...
return view(view: 'welcome3')->with(compact('offers'),-> with(['success' => 'تم تحديث البيانات بنجاح']);
);

 return view(view: 'welcome3')
}
