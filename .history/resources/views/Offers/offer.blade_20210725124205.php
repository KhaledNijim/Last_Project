                ...
                <div >
                    ...
                    <form method="POST" action="{{route('offer-Post')}}" >
                        ...
                        <div class="form-group row">
                            <label for="name" > {{__(key:'messages.Offer_name')}} Offer name &nbsp;</label>
                        ...
                        <div class="form-group row">
                            <label for="email" >{{__(key:'messages.Offer_price')}} Offer price &nbsp;&nbsp;</label>
                        ...
                        <div class="form-group row">
                            <label for="email" >{{__(key:'messages.Offer_details')}} Offer details</label>
