...
if(LaravelLocalization::getSupportedLocales() as $localeCode => $properties == العربية)
 {{--direction: rtl;--}}
    ...
    echo "LaravelLocalization::getLocalizedURL($localeCode, null, [], true) ";
    var_dump("LaravelLocalization::getLocalizedURL($localeCode, null, [], true) ");
