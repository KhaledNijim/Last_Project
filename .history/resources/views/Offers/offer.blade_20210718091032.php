                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('offer-Post')}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" style="padding: 5px 80px 00px 80px;" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="price" style="padding: 5px 80px 00px 80px;" >
                                <small class=""> </small>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="details" style="padding: 5px 80px 00px 80px;" >
                            </div>
                        </div>
