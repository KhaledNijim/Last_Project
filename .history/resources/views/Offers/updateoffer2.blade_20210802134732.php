                    ...
                    <form method="POST" action="{{route('offer-Post')}}" >
                        ...
                        <div class="form-group row">
                            <label for="name" > {{__(key:'messages.Offer_name_ar')}} &nbsp; </label>
                                <div class="col-md-6">
                                <input id="name_ar" type="text"  name="name_ar" value="{{$offer2 -> name_ar}}" placeholder="name_ar"  style="padding: 5px 80px 00px 00px;" {{--required--}}>
                               @error('name_ar')
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name_en" type="text"  name="name_en" value="{{$offer2 -> name_en}}" placeholder="name_en"  style="padding: 5px 80px 00px 00px;" {{--required--}}>
                           @error('name_en')
                            <small class="form-text text-danger">{{$message}}</small>
                           @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text"  name="price" value="{{$offer2 -> price}}" placeholder="price"  style="padding: 5px 80px 00px 00px;" >
                                @error('price')
                                <small class="form-text text-danger">{{$message}}</small>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text"  name="details_ar" value="{{$offer2 -> details_ar}}" placeholder="details_ar" style="padding: 5px 80px 00px 00px;" >
                                @error('details_ar')
                                <small class="form-text text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text"  name="details_en" value="{{$offer2 -> details_en}}" placeholder="details_en" style="padding: 5px 80px 00px 00px;" >
                                @error('details_en')
                                <small class="form-text text-danger">{{$message}}</small>
                                @enderror
                            </div>
