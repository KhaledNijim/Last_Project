                ...
                <div >
                    ...
                    <form method="POST" action="{{route('offer-Post')}}" >
                        ...
                        <div class="form-group row">
                            <label for="name" > {{__(key:'messages.Offer_name')}} &nbsp; <br></label>
                        ...
                        <div class="form-group row">
                            <label for="email" >{{__(key:'messages.Offer_price')}} &nbsp;&nbsp;<br></label>
                        ...
                        <div class="form-group row">
                            <label for="email" >{{__(key:'messages.Offer_details')}}<br></label>
