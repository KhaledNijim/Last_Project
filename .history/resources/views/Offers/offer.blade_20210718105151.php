<html>
  ...
  >
    <div class="container" style=" background-color:  #64aedf;      margin: 115px 200px 200px 200px ; padding: 50px 50px 50px 100px;">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('offer-Post')}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="price" placeholder="price"   >
                                @error('price')
                                <small class="form-text text-danger">{{$message}}</small>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="details" placeholder="details"  >
                                @error('details')
                                <small class="form-text text-danger">{{$message}}</small>
                                @enderror
                            </div>
