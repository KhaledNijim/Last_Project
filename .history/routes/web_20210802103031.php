...
////////////////////////////////////////////////
Route::group(['prefix' =>LaravelLocalization::setLocale(),'prefix' => 'offer',
'middleware' => [ 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath']], function(){

    Route::get ('1', 'ThirdController@offer_view');
    Route::post('2', 'ThirdController@offer_post' )-> name ('offer-Post');

    Route::get ('3', 'ThirdController@create');
    Route::get ('4', 'ThirdController@store');
